...
import netrImg from '@/assets/project-netr.jpg';
import resumeImg from '@/assets/project-resume.jpg';
import recommendImg from '@/assets/project-recommend.jpg';
import codeImg from '@/assets/project-code.jpg';
...
export default function Projects() {
  ...
  const projects = [
    {
      title: 'Project Netr',
      description: 'An opportunity-finding platform connecting farmers, children, widows, and underserved communities to scholarships, government schemes, jobs, and support programs they qualify for.',
      icon: FileText,
      image: netrImg,
      github: null,
      demo: 'https://project-netr.vercel.app/',
      tags: ['Opportunity Discovery', 'Social Impact', 'React', 'AI Matching'],
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {projects.map((project, index) => (
            ...
            >
              <div
                className="rounded-2xl border border-white/[0.07] hover:border-white/[0.12] transition-all duration-300 hover:-translate-y-1 h-full overflow-hidden flex flex-col"
